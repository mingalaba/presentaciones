...
Miren esto. Tenemos respuestas que van desde los 2 minutos hasta los 15 minutos. Si esto fuera una Planning, estaríamos discutiendo a los gritos. ¿El de 15 minutos es un ineficiente? ¿El de 2 minutos hace un té de mala calidad? No. La diferencia radica en los supuestos no declarados. El de 2 minutos asumió que el agua ya estaba hirviendo y el saquito en la taza. El de 15 minutos asumió que tenía que ir a la cocina, lavar la taza, llenar la pava y esperar. En el código pasa exactamente igual. Cuando alguien dice 'esto me toma 4 horas', está asumiendo que la base de datos está lista y no hay deuda técnica. Las discrepancias en estimación rara vez son por falta de habilidad, son por falta de alineación en los criterios de aceptación y los supuestos.`,
    // Slide 6
    `Esta es la trampa mortal de las horas absolutas. Imaginen que refinamos una historia y le preguntamos a nuestro Dev más Senior cuánto le toma. Dirá: '2 horas'. Le preguntamos al Dev Junior y dirá: '8 horas'. ¿Qué número ponemos en el plan? Si usamos horas, la planificación se vuelve dependiente de quién agarre el ticket.

Llegados a este punto, sé perfectamente lo que muchos de ustedes están pensando. Es la duda más válida e inevitable en esta transición. Se están preguntando: '¿Qué pasa en un equipo donde no todos hacen lo mismo? Yo hago Backend, ¿cómo voy a estimar algo de Frontend o de QA?' Y, sumado a eso: 'Es una realidad innegable que si el ticket lo agarra el Senior tardará menos, y si lo agarra el Junior tardará más. Aquí la estimación se nos está mezclando con la planificación'.

Me encanta abordar esto porque es justo donde la gestión tradicional se rompe y donde este modelo brilla. Vamos a desarmar esa inquietud separando de una vez por todas el 'Tamaño' de la 'Duración'.

Primero, el dilema del Senior vs. Junior. La clave es entender que el tamaño de un problema es un hecho universal, mientras que el tiempo de ejecución es relativo a la capacidad de la persona. Imaginen que el requerimiento es subir un piano de cola por las escaleras hasta un tercer piso. El peso del piano, lo estrecho de la escalera y el riesgo de que se caiga (es decir, el tamaño del problema) son factores fijos. Si el trabajo lo hace un levantador de pesas olímpico, quizás le tome 30 minutos. Si lo hace alguien que no entrena nunca, le tomará 3 horas. El tiempo cambia drásticamente, pero el piano sigue siendo exactamente el mismo piano. Si estimamos en horas, somos rehenes de quién asigne el ticket, lo cual le impide al Product Owner priorizar a futuro. Al estimar en Puntos, el Senior y el Junior acuerdan que mover el piano es un '8' de complejidad. Acordamos el tamaño, y dejamos que el equipo absorba el tiempo.

Segundo, el dilema de los perfiles distintos (Back, Front, QA). Cuando un desarrollador dice 'no puedo estimar esto porque no es mi especialidad', está asumiendo que el objetivo de estimar es adivinar el tiempo de tipeo de su compañero. Tenemos que erradicar esa idea. En agilidad, no entregamos 'código de backend'; entregamos funcionalidades completas al usuario.
El valor real de que un QA o un Backend participe en la estimación de una historia de Frontend no radica en que sepan escribir en React. Su valor está en la perspectiva sistémica y en descubrir puntos ciegos. Al analizar el ticket, el Backend puede advertir: 'Si haces esa consulta al vuelo en el Front, vas a saturar mi base de datos'. El QA puede decir: 'Esa interfaz parece fácil, pero automatizar las pruebas en todos los dispositivos nos tomará días'. Si el especialista de Front vota un 2, pero el QA vota un 8, esa discrepancia acaba de salvar el Sprint, porque obligó a conversar sobre riesgos de integración que el Front no había contemplado.

Tercero, ¿cómo planificamos entonces? Aquí es donde entra la Velocidad como nuestro amortiguador matemático. La Velocidad (el promedio de puntos terminados por Sprint) no es un número teórico ideal. Si este equipo está compuesto por un Senior hiper-productivo, dos Juniors en aprendizaje y un QA a medio tiempo, su velocidad histórica natural reflejará exactamente esa configuración y sus tiempos reales. Si la velocidad demostrada del equipo es de 30 puntos por Sprint, el Negocio sabe a qué atenerse. No importa si en el día a día el Junior toma el ticket más largo o si el Senior asume más carga; la variabilidad individual y los tiempos de ejecución ya están absorbidos y promediados en la métrica de Velocidad de todo el equipo.

Por eso abandonamos las horas. Las horas nos dividen y nos obligan a adivinar el futuro individual. Los Puntos de Historia nos unen en torno a la complejidad real del producto.`,
    // Slide 7
